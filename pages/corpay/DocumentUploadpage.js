    ...
    class DocumentUploadpage {
        ...
        async uploadCompanyDocumentsForKyc() {
            ...
            const filenames = [
                ...
                'tests\\corpay\\Document_upload\\Memorandum and Articles of Association of the company.pdf',

                'tests\\corpay\\Document_upload\\Proof of permanent company address.pdf',

                'tests\\corpay\\Document_upload\\Certificate of Directors.pdf',

                'tests\\corpay\\Document_upload\\Certificate of Incorporation.pdf',

                'tests\\corpay\\Document_upload\\Certificate of Registered Office.pdf',

                'tests\\corpay\\Document_upload\\Certificate of Shareholders.pdf',

                'tests\\corpay\\Document_upload\\Recent Financial Statements Management Accounts.pdf',

                'tests\\corpay\\Document_upload\\Tax Returns.pdf'
        ...
        async uploadIndividualDocumentsforKyc() {
            ...
            const filenames = [
                ...
                'tests\\corpay\\Document_upload\\Curriculum vitae.pdf',

                'tests\\corpay\\Document_upload\\Passport.pdf',

                'tests\\corpay\\Document_upload\\Proof of permanent residential address.pdf'
            ]
        ...
        async uploadLarge_file_size_ForKyc() {
            ...
            const filenames = [
                ...
                'tests\\corpay\\Document_upload\\Large file.zip'
            ]
