...
exports.Beneficiarypage =
  class Beneficiarypage {
    ...
    async verifyBeneficiaryCreationforGbp() {
      ...
      await this.page.fill(this.iban_no, 'GB99BUKB20000012345600')
    ...
    async verifyBeneficiaryCreationfor_CAD() {
      ...
      await this.page.fill(this.account_number,"8878143")
      await this.page.fill(this.routing_code, "00012345")
      await this.page.fill(this.bic_swift, "BOFMCAM2")
      //await this.page.waitForTimeout(3000)
      await this.page.click(this.bank_name)
      await this.page.waitForTimeout(3000)
