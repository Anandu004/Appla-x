...
import { Admin_FeeManagement } from '../../../pages/Currency_cloud/BASE_USD/Admin_FeeManagement'





test(' Verify tariff fee deduction for transaction investigation with USD as base currency', async ({ page }) => {
...
test(' Verify tariff fee deduction for Recall or cancel outgoing transaction with USD as base currency', async ({ page }) => {
...
test(' Verify tariff fee deduction for Outgoing Transaction Amendment with USD as base currency', async ({ page }) => {
...
test(' Verify tariff fee deduction for Cancel / Return Incoming Transaction with USD as base currency', async ({ page }) => {
...
test(' Verify tariff fee deduction for Annual Audit Reports with USD as base currency', async ({ page }) => {
...
test(' Verify tariff fee deduction for Closing of Account with USD as base currency', async ({ page }) => {
...
test(' Verify tariff fee deduction for Change of Ownership structure / Review with USD as base currency', async ({ page }) => {
...
test(' Verify tariff fee deduction for Confimation / Reference Letter with USD as base currency', async ({ page }) => {
...
test(' Verify tariff fee deduction for Extraordinary Due Diligance fee with USD as base currency', async ({ page }) => {
