...
import { Admindashboardpage } from '../../../pages/Currency_cloud/BASE_EURO/Admindashboardpage';
...
test.only('4. Verify different payment fees  can be set for different payment types.',async ({ page }) => {
